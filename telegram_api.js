// The BotAPI is promise-based. It needs ES6-type promises to work
if (typeof Promise == "undefined") {
	throw new Error("There is no global Promise-object. Please use a newer JS-engine or polyfill it. The npm-package es6-promise works nice");
}
...
BotAPI.prototype = {
	...
	token: "",
	/**
	 * A simple method for testing your bot's auth token. Requires no parameters. Returns basic information about the bot in form of a TODOUser object.
	 *
	 * @return {User}	Basic information about the bot in form of a TODOUser object
	 */
	getMe: function() {
		return this._doRequest("getMe");
	},
	/**
	 * Use this method to forward messages of any kind. On success, the sent TODOMessage is returned.
	 ...
	 *
	 * @return {Message}	The sent TODOMessage
	 */
	sendMessage: function(
		...
		return this._doRequest(method, data);
	},
	/**
	 * Use this method to forward messages of any kind. On success, the sent TODOMessage is returned.
	 * @param {Integer} chat_id	ID of the chat to send the message to
	 * @param {Integer} from_chat_id	Unique identifier for the chat where the original message was sent — TODOUser or TODOGroupChat id
	...
	/**
	 * Use this method to send photos. On success, the sent TODOMessage is returned.
	 * @param {Integer} chat_id	ID of the chat to send the message to
...
return unimplemented();
	...
	/**
	 * Use this method to send audio files, if you want Telegram clients to display the file as a playable voice message. For this to work, your audio must be in an .ogg file encoded with OPUS (other formats may be sent as Document). On success, the sent TODOMessage is returned.
	 * @param {Integer} chat_id	ID of the chat to send the message to
...
return unimplemented();
	...
	/**
	 * Use this method to send general files. On success, the sent TODOMessage is returned.
	 * @param {Integer} chat_id	ID of the chat to send the message to
...
return unimplemented();
	...
	/**
	 * Use this method to send .webp stickers. On success, the sent TODOMessage is returned.
	 * @param {Integer} chat_id	ID of the chat to send the message to
...
return unimplemented();
	...
	/**
	 * Use this method to send video files, Telegram clients support mp4 videos (other formats may be sent as Document). On success, the sent TODOMessage is returned.
	 * @param {Integer} chat_id	ID of the chat to send the message to
...
return unimplemented();
	...
	/**
	 * Use this method to send point on the map. On success, the sent TODOMessage is returned.
	 * @param {Integer} chat_id	ID of the chat to send the message to
	...
	/**
	 * Use this method to get a list of profile pictures for a user. Returns a TODOUserProfilePhotos object.
	...
	/**
	 * Use this method to receive incoming updates using long polling (wiki). An Array of TODOUpdate objects is returned.
	...
	setWebhook: function(url) {
		...
		return this._doRequest(apiurl, data);
	},
	/**
